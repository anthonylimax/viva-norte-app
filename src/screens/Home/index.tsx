...
export default function Home({ navigation }: NavigationProp) {
    ...
    return (
        <SafeAreaView style={style.view}>
            ...
            <FlatList ListHeaderComponent={ListHeaderComponent} showsVerticalScrollIndicator={false} data={data} ItemSeparatorComponent={Component.Separator} renderItem={({ item }) : any => {
                refIndex.current++;
